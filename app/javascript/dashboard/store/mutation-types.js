export default {
  ...
  // Custom Roles (Self-developed)
  SET_CUSTOM_ROLES: 'SET_CUSTOM_ROLES',
  ADD_CUSTOM_ROLE: 'ADD_CUSTOM_ROLE',
  EDIT_CUSTOM_ROLE: 'EDIT_CUSTOM_ROLE',
  DELETE_CUSTOM_ROLE: 'DELETE_CUSTOM_ROLE',
  SET_CUSTOM_ROLES_UI_FLAG: 'SET_CUSTOM_ROLES_UI_FLAG',
  SET_CUSTOM_ROLES_META: 'SET_CUSTOM_ROLES_META',
  SET_SELECTED_CUSTOM_ROLE: 'SET_SELECTED_CUSTOM_ROLE',
};
